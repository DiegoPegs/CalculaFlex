package br.com.diegohcc.calculaflex

import android.support.v7.app.AppCompatActivity
import android.os.Bundle
import br.com.diegohcc.calculaflex.extentions.format
...
class ResultActivity : AppCompatActivity() {
    ...
    private fun calculate() {
        ...
        if(priceIndice <= performanceMyCar) tvSuggestion.text = getString(R.string.label_ethanol)
        else tvSuggestion.text = getString(R.string.label_gasoline)
